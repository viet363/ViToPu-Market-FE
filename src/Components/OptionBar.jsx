              ...
              <Link to="/Notification">
                <div>
                  <svg
                    ...
                    viewBox="0 0 448 512"
                    fill={location.pathname === "/Notification" ? "rgba(123,173,182,1)" : "#fff"}
                  >
              ...
              <Link to="/">
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512"
                    fill={location.pathname === "/" ? "rgba(123,173,182,1)" : "#fff"}
                  >
              ...
              <Link to="/Cart">
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512"
                    fill={location.pathname === "/Cart" ? "rgba(123,173,182,1)" : "#fff"}
                  >
